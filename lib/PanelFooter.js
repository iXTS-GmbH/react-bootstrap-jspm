...
var PanelFooter = function(_React$Component) {
  ...
  PanelFooter.prototype.render = function render() {
    ...
    return _react2.default.createElement('div', (0, _extends3.default)({}, elementProps, {className: (0, _classnames2.default)(className, (0, _bootstrapUtils.prefix)(bsProps, 'footer'))}), children);
  };
  return PanelFooter;
