...
var PanelHeading = function(_React$Component) {
  ...
  PanelHeading.prototype.render = function render() {
    ...
    return _react2.default.createElement(Component, (0, _extends3.default)({}, elementProps, {className: (0, _classnames2.default)(className, (0, _bootstrapUtils.prefix)(bsProps, 'heading'))}), children);
  };
  return PanelHeading;
