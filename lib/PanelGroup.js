...
var childContextTypes = {$bs_panelGroup: _propTypes2.default.shape({
...
var PanelGroup = function(_React$Component) {
  ...
  PanelGroup.prototype.getChildContext = function getChildContext() {
    ...
    return {$bs_panelGroup: (0, _extends3.default)({
        getId: getId,
        headerRole: 'tab',
        panelRole: 'tabpanel'
      }, accordion && {
  ...
  PanelGroup.prototype.render = function render() {
    ...
    return _react2.default.createElement('div', (0, _extends3.default)({}, elementProps, {className: (0, _classnames2.default)(className, classes)}), _ValidComponentChildren2.default.map(children, function(child) {
      return (0, _react.cloneElement)(child, {bsStyle: child.props.bsStyle || bsProps.bsStyle});
    }));
  };
  return PanelGroup;
...
exports.default = (0, _uncontrollable2.default)((0, _bootstrapUtils.bsClass)('panel-group', PanelGroup), {activeKey: 'onSelect'});
