...
(function(process) {
  ...
  var contextTypes = {$bs_panelGroup: _propTypes2.default.shape({
      getId: _propTypes2.default.func,
      activeKey: _propTypes2.default.any,
      onToggle: _propTypes2.default.func
    })};
  var childContextTypes = {$bs_panel: _propTypes2.default.shape({
  ...
  var Panel = function(_React$Component) {
    ...
    Panel.prototype.getChildContext = function getChildContext() {
      ...
      return {$bs_panel: (0, _extends3.default)({}, ids, {
